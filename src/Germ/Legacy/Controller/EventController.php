...
use Germ\Legacy\Model\Germ\EventSchema\Event;
use Germ\Legacy\Model\Germ\EventSchema\EventModel;
use Germ\Legacy\Model\Germ\EventSchema\EventTypeModel;
...
class EventController extends AbstractController
{
    ...
    public function editAction(Request $request, $eventId)
    {
        ...
        if ($eventForm->isSubmitted() && $eventForm->isValid()) {
            ...
            $eventModel = $this->pomm['germ']->getModelLayer('Germ\Legacy\Model\Germ\EventSchema\EventModelLayer');
    ...
    public function showAction(Request $request, $eventId)
    {
        $eventModel = $this->pomm['germ']
            ->getModel('Germ\Legacy\Model\Germ\EventSchema\EventModel');
        $event = $this->getEventOr404($eventId);
        if (! $event) {
    ...
    private function buildEventForm(Event $event)
    {
        ...
        $personModel = $this->pomm['germ']->getModel('Germ\Legacy\Model\Germ\PersonSchema\PersonModel');
