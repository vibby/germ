...
use Germ\Legacy\Model\Germ\EventSchema\AutoStructure\Event as EventStructure;
...
class EventModel extends Model
{
    ...
    public function __construct()
    {
        ...
        $this->flexible_entity_class = '\Germ\Legacy\Model\Germ\EventSchema\Event';
    }
    ...
    public function hydrateDockets(Event $event)
    {
        $docketModel = $this
            ->getSession()
            ->getModel('\Germ\Legacy\Model\Germ\EventSchema\DocketModel')
            ;
    ...
    public function getEventById($eventId)
    {
        $eventTypeModel = $this
            ->getSession()
            ->getModel('\Germ\Legacy\Model\Germ\EventSchema\EventTypeModel')
            ;
        $locationModel = $this
            ->getSession()
            ->getModel('\Germ\Legacy\Model\Germ\EventSchema\LocationModel')
            ;
