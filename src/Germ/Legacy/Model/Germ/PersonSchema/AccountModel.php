...
namespace Germ\Legacy\Model\Germ\PersonSchema;

use Germ\Legacy\Model\Germ\PersonSchema\AutoStructure\Account as AccountStructure;
...
class AccountModel extends Model
{
    ...
    public function __construct()
    {
        ...
        $this->flexible_entity_class = '\Germ\Legacy\Model\Germ\PersonSchema\Account';
    }
        ...
        $sql = strtr(
            ...
            [
                ...
                ':church_relation' => $this->getSession()
                    ->getModel('\Germ\Legacy\Model\Germ\ChurchSchema\ChurchModel')
                    ->getStructure()
                    ->getRelation(),
                ':condition' => $where,
            ]
